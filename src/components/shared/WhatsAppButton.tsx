...
export function FloatingWhatsAppButton({
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-2">
      ...
      <button
        onClick={handleClick}
        className="group relative rounded-full shadow-lg hover:shadow-2xl bg-[#25D366] hover:bg-[#20BA5A] text-white transition-all duration-300 hover:scale-110 w-16 h-16 flex items-center justify-center"
