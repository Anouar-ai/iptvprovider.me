...
export const metadata: Metadata = generateMeta({
  title: 'Top IPTV Providers 2025 | 24,000+ Channels | USA, UK & Worldwide',
  description: 'Compare the best IPTV providers in 2025. Subscribe to premium IPTV service with 24,000+ live channels, HD/4K quality, instant activation & 24/7 support. Try free trial today.',
  canonical: '/',
});
...
const Pricing = dynamic(() => import("@/components/sections/Pricing").then(mod => mod.Pricing), {
  loading: () => <div className="h-[600px] animate-pulse bg-muted/20 rounded-lg" />,
});
...
export default async function Home() {
  ...
  const { getEnhancedHomePageData } = await import("@/lib/data/home-page-enhanced");
  const {
    localBusinessUSA,
    localBusinessUK,
    localBusinessWorld,
