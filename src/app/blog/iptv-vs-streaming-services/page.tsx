                ...
                <Container>
                    ...
                    <div className="text-center max-w-4xl mx-auto mb-16">
                        ...
                        <p className="text-xl text-muted-foreground mb-4">
                            <strong>Paying $100+/month for Netflix, Hulu, Disney+, and YouTube TV?</strong> There's a smarter way.
                        </p>

                        <p className="text-lg text-muted-foreground mb-8">
                            We compared IPTV with popular streaming services (Netflix, Hulu, Disney+, YouTube TV) to show you how to get <strong>live TV + on-demand content for $15/month</strong> instead of $100+/month.
                        </p>
                    </div>
                    ...
                    <section id="problem" className="mb-16 max-w-3xl mx-auto scroll-mt-20">
                        <h2 className="font-headline text-3xl font-bold mb-6">The Streaming Subscription Problem</h2>

                        <p className="text-lg mb-6">
                            Most people now pay for <strong>4-6 streaming services</strong>:
                        </p>

                        <div className="space-y-3 mb-6">
                            {[
                                { service: "Netflix", price: "$15.49/month", content: "Movies & shows (no live TV)" },
                                { service: "Hulu", price: "$17.99/month", content: "Shows & limited live TV" },
                                { service: "Disney+", price: "$13.99/month", content: "Disney content only" },
                                { service: "HBO Max", price: "$15.99/month", content: "HBO shows & movies" },
                                { service: "YouTube TV", price: "$72.99/month", content: "Live TV channels" },
                                { service: "Paramount+", price: "$11.99/month", content: "CBS shows & movies" },
                            ].map((item) => (
                        ...
                        <div className="p-6 bg-red-500/10 border-2 border-red-500/30 rounded-xl">
                            <div className="text-center">
                                <div className="text-sm text-muted-foreground mb-2">Total Monthly Cost:</div>
                                <div className="text-4xl font-bold text-red-600 mb-2">$148.44</div>
                                <div className="text-sm text-muted-foreground">$1,781/year for fragmented content</div>
                            </div>
                        </div>
                    </section>
                    ...
                    <section id="solution" className="mb-16 max-w-3xl mx-auto scroll-mt-20">
                        ...
                        <div className="p-6 bg-gradient-to-r from-green-500/10 to-green-500/5 rounded-xl border border-green-500/20">
                            <h3 className="font-bold text-xl mb-3 text-center">Annual Savings</h3>
                            <div className="text-center">
                                <div className="text-4xl font-bold text-green-600 mb-2">$1,589</div>
                                <p className="text-sm text-muted-foreground">per year by switching to IPTV</p>
                            </div>
                        </div>
                    </section>
                    ...
                    <section className="mb-16 max-w-3xl mx-auto bg-gradient-to-r from-primary/10 to-primary/5 p-8 rounded-xl border border-primary/20">
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-sm text-muted-foreground mb-4">vs $148/month for all streaming services</p>
                            <p className="font-semibold text-green-600">Save $116.52/month ($1,398/year)</p>
                        </div>
                    </section>
                    ...
                    <section className="mb-16 max-w-3xl mx-auto bg-gradient-to-r from-primary/10 to-primary/5 p-8 rounded-xl border border-primary/20">
                        ...
                        <p className="text-center text-lg mb-6">
                            Get <strong>live TV + on-demand content</strong> for less than the cost of Netflix alone.
                        </p>
